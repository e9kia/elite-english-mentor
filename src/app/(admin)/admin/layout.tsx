        ...
        <div className="mx-auto max-w-7xl px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            {[
              ...
              { label: "Words & Import", href: "/admin/words",     icon: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" },
              { label: "Story Builder", href: "/admin/stories", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
